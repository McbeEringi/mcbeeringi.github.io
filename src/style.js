...
const _init=()=>{
	...
	header>input{appearance:none;-webkit-appearance:none;flex-shrink:0;display:block;width:48px;height:48px;margin:0;border-radius:50%;background:no-repeat center/70% url(https://icongr.am/material/menu.svg?color=ffffff);}
