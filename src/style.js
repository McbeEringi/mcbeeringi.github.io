...
const setstyle=()=>{
	...
	//document.querySelectorAll('.lang').forEach(e=>e.href='https://translate.google.com/translate?sl=ja&tl=en&u='+location.href);//<a class="lang"></a>
