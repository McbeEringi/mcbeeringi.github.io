(()=>{
	...
	send({mobile:+('ontouchend'in d),ua:n.userAgent,scr:[screen.width,screen.height],dpr:devicePixelRatio,lang:n.language,t:Date.now(),ref:d.referrer,loc:d.location.origin+d.location.pathname+d.location.search});
