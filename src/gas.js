(()=>{
	...
	send({ua:n.userAgent,scr:[screen.width,screen.height],dpr:devicePixelRatio,lang:n.language,t:Date.now(),touch:'ontouchend'in d,ref:d.referrer,loc:d.location.origin+d.location.pathname});
	['error','unhandledrejection'/*,'rejectionhandled'*/].forEach(y=>addEventListener(y,e=>send({err:(e.reason||e).toString()})));
})();